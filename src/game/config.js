...
import ElevatorRoomScene from '../scenes/ElevatorRoomScene.js';
...
export const gameConfig = {
  ...
  audio: { noAudio: true },
  scene: [BootScene, TitleScene, OutsideScene, BusBoardingScene, BusInteriorScene, ParkingGarageScene, ElevatorRoomScene],
};
